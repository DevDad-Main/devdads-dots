...
hl.bind("SUPER +  SHIFT +  K", hl.dsp.global("quickshell:oskToggle"), { description = "Toggle on-screen keyboard" })
...
hl.bind("SUPER + SHIFT +  J", hl.dsp.global("quickshell:barToggle"), { description = "Toggle bar" })
